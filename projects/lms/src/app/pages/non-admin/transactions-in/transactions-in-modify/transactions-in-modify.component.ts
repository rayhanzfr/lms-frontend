...
export class NonTransactionsInModifyComponent implements OnInit {
  ...
  getAllTransactionsOutByUsersResDto?:GetAllTransactionsOutByUsersResDto
  ...
  ngOnInit(): void {
    ...
    this.transactionsOutSubs=this.transactionOutService.getAllByUsers().subscribe(result=>{
      this.getAllTransactionsOutByUsersResDto=result
      this.transactionsOut=this.getAllTransactionsOutByUsersResDto.getTransactionsOutDataDto
    })
  }
  findDetails(){
  ...
  submitData(){
    ...
    this.transactionsInService.insertAll(this.saveFullTransactionsInReqDto).subscribe(result=>{
      ...
      if (this.saveFullTransactionsInResDto) {
        this.router.navigateByUrl("non-admin/transactions-in")
      }
    })
  }
